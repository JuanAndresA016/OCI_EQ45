    ...
    const handleCreateTask = async () => {
        ...
        try {
            ...
            const updated = await fetch(
                        `${API_URL}/api/tareas/proyectos/${proyecto_id}/tareas?creadorId=${user.id}&padreId=${tarea_id}`,
            );
        ...
        const init = async () => {
            try {
                ...
                try {
                    ...
                    const res = await fetch(
                        `${API_URL}/api/tareas/proyectos/${proyecto_id}/tareas?creadorId=${userData.id}&padreId=${tarea_id}`,
                        {
                            headers: {
                                "Authorization": "Bearer " + token
                            }
                ...
                <div className="dashboard_container_content">
                    <div className="dashboard_container_content">
                        ...
                        <div className="roles_section">
                                ...
                                return (
                                    <span key={r.rolId} className="role_tag">
                                        ...
                                        <i
                                            ...
                                            onClick={() => handleRemoveRol(r.rolId)}
                            ...
                            <select
                                onChange={(e) => handleAssignRol(e.target.value)}
                                defaultValue=""
                            >
...
<div>
                            ...
                            <AiCopilot
        proyectoId={proyecto_id}
        tareaPadreId={Number(tarea_id)}
        onPlanApplied={() => fetchTasks(user.id)}
    />
                                ...
                                {porHacer.map(task => (
                                    <div className="task_card" key={task.id}>
                                        <div className="actions_card">
                                            <a href={`/proyecto/${proyecto_id}/tarea/${task.id}`} className="task_title">
                                                {task.titulo}
                                            </a>
