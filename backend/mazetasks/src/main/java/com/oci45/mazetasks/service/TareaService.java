...
public class TareaService {
    ...
    public TareaService(TareaRepository repo, TareaEmbeddingService tareaEmbeddingService) {
        this.repo = repo;
    ...
    public Tarea crear(Tarea tarea) {
        Tarea tareaGuardada = repo.save(tarea);

        tareaEmbeddingService.crearOActualizarEmbedding(tareaGuardada);
    ...
    public Tarea actualizar(Long id, Tarea nueva) {
        ...
        Tarea tareaActualizada = repo.save(t);

        tareaEmbeddingService.crearOActualizarEmbedding(tareaActualizada);
    ...
    public List<Tarea> obtenerTareas(Long proyectoId, Long creadorId, Long padreId) {
        return repo.findTareasByProyectoAndCreadorAndPadre(proyectoId, creadorId, padreId);
    }
